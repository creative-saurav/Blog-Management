...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/backend/images/logo.png') }}" type="image/x-icon">
    <!-- Bootstrap -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/vendors/tagify/tagify.css') }}">
    <!-- select 2 -->
...
<body>
    ...
    <script src="{{ asset('assets/backend/icon-picker/fontawesome-iconpicker.min.js') }}"></script>
     ...
     <script src="{{ asset('assets/backend/vendors/tinyeditor/tinymce.min.js') }}"></script>
     <script src="{{ asset('assets/backend/vendors/tinyeditor/tiny-active.js') }}"></script>
     <script src="{{ asset('assets/backend/vendors/tagify/tagify.js') }}"></script>
     <script src="{{ asset('assets/backend/vendors/tagify/tagify.polyfills.min.js') }}"></script>
