...
@section('title', get_phrase('Add Blog') . ' | ' . get_phrase('Blog Management System') )
...
<form action="{{route('admin.blog.store')}}"  method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control ol-form-control" id="title" name="title" placeholder="{{get_phrase('Enter blog title')}}" required>
    </div>
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control ol-form-textarea" name="summary" id="summary" placeholder="here"></textarea>
    </div>
     <div class="mb-3">
        <label for="tag" class="form-label ol-form-label">{{get_phrase('Keywords')}}</label>
        <input type="text" class="form-control ol-form-control" name="tags" id="tags"  placeholder="{{get_phrase('Enter blog keywords')}}">
    </div>
 
    <div class="mb-3">
        <label for="oleditor" class="form-label ol-form-label">{{get_phrase('Description')}}</label>
        <textarea id="oleditor" name="description"></textarea>
    </div>
     <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="file" name="banner_image" class="form-control ol-form-control" id="banner_image">
    </div>
