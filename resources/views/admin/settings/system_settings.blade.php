...
<div class="row mt-3">
        ...
        <div class="ol-card">
            ...
            <form action="{{route('admin.system_settings.update')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control ol-form-control" name="keyword" id="tags" value="{{get_settings('keyword')}}" required>
                </div>
                <div class="mb-3">
    ...
    <div class="col-sm-6">
        ...
        <div class="ol-card">
            <div class="ol-card-body p-3 py-4">
                <form action="{{route('admin.system_settings_social.update')}}" method="post" enctype="multipart/form-data\">
                    @csrf
                    <div class="mb-3">
