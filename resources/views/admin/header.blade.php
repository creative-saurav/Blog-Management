...
<div class="ol-header print-d-none d-flex align-items-center justify-content-between py-2 ps-3">
    <div class="header-title-menubar d-flex align-items-start flex-wrap mt-md-1">
        ...
        <a href="" target="_blank" class="btn btn-sm p-0 ms-4 ms-md-2 text-14px text-muted">
            <span>View site</span>
    ...
    <div class="header-content-right d-flex align-items-center justify-content-end">
        ...
        <div class="d-none d-sm-block">
            <div class="img-text-select ">
                ...
                <div class="selected-show" data-bs-toggle="tooltip" data-bs-placement="left" title="Language">
        ...
        <div class="header-dropdown-md">
            ...
            <div class="header-dorpdown-menu-md p-3">
                <div class="d-flex column-gap-2 mb-12px pb-12px ol-border-bottom-2">
                    ...
                    <div>
                        <h6 class="title fs-12px mb-2px"> name </h6>
                        <p class="sub-title fs-12px"> 'Admin </p>
                    </div>
                </div>
                <ul class="mb-12px">
                    <li class="dropdown-list-1"><a class="dropdown-item-1" href=""> My Profile </a></li>
                    <li class="dropdown-list-1"><a class="dropdown-item-1" href="{{ route('logout') }}"> Sign Out </a></li>
                </ul>
            </div>
        </div>
    </div>
