...
@section('title', get_phrase('Categories') . ' | ' . get_phrase('Blog Management System') )
                    ...
                    <td> 
                        <div class="dropdown ol-icon-dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item fs-14px" onclick="edit_modal('modal-md','{{route('admin.blog.category.edit',['id'=>$category->id])}}','{{get_phrase('Update Category')}}')" href="javascript:void(0);"> {{get_phrase('Edit')}} </a></li>
